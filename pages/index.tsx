...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="no-scrollbar m-auto mt-[5vh] h-[90vh] w-[90vw] overflow-y-scroll rounded-[8px] border-[1px] border-gray-200 bg-dark-200 transition-all duration-300 ease-in relative z-20">
        <div
          id="spotlight"
